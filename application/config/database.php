...
36.66.237.177: icmp_seq=311 ttl=50 time=106.699 ms
64 bytes from 36.66.237.177:
*/
...
// $db['oracle']['hostname'] = '36.66.237.177';

$db['oracle']['hostname'] = $tnsname;
$db['oracle']['username'] = 'dbsifik_kalbar';
$db['oracle']['password'] = 'p1k1r3ndh3w3';
$db['oracle']['database'] = 'orcl';
